...
pauseButton = Tkinter.Button(tk, text ="Stop", command = pauseListener)
startButton = Tkinter.Button(tk, text ="Start", command = restart)
exitButton = Tkinter.Button(tk, text = "Exit", command = exit)
